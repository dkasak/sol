...
dbmp_objects = dbmp.o
sol_objects = sol.o BRDF.o Film.o Sampler.o Plane.o ColourRGB.o Light.o Material.o Ray.o World.o Screen.o Intersection.o Shape.o Sphere.o Vector.o Debug.o Options.o Camera.o Tracer.o
