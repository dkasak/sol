...
dbmp_objects = dbmp.o
sol_objects = sol.o Plane.o ColourRGB.o Light.o Material.o Point.o Ray.o Scene.o Screen.o ShadeInfo.o Shape.o Sphere.o Vector.o Debug.o Options.o Camera.o
